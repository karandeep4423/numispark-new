...
const Home = () => {
  return (
    <div>
      ...
      {/* Qui sommes nous */}
      <div className="my-16 flex flex-col items-center gap-6 mx-10">
        <h2 className="text-[#8F8F8F] text-center font-mono text-sm font-normal leading-normal">
          {"{Qui sommes nous}"}
        </h2>
        <p className="text-center font-[Neue_Montreal] text-[42px] font-medium leading-[50px] text-black">
      ...
      {/* Stats — 3 columns */}
      <div className="mt-16 grid grid-cols-3 gap-16 mx-10">
        <div className="group mb-16 px-8 pt-8 pb-4 border-t-2 border-[#E0E0E0] hover:border-black transition-all duration-600 bg-[linear-gradient(127deg,transparent_0%,transparent_100%)] hover:bg-[linear-gradient(127deg,#E7ECF2_3.71%,rgba(231,236,242,0)_40.97%)]">
          <p className="font-[Neue_Montreal] text-[80px] font-medium leading-none text-black mb-6 transition-all duration-600 group-hover:translate-y-1">
            +60
          </p>
          <p className="font-[Neue_Montreal] transition-all duration-600 group-hover:-translate-y-1 text-[14px] font-normal leading-[22px] text-[#7F7F7F] group-hover:text-black">
        ...
        <div className="group px-8 pt-8 pb-4 border-t-2 border-[#E0E0E0] hover:border-black transition-all duration-600 bg-[linear-gradient(127deg,transparent_0%,transparent_100%)] hover:bg-[linear-gradient(127deg,#E7ECF2_3.71%,rgba(231,236,242,0)_40.97%)]">
          ...
          <p className="font-[Neue_Montreal]  group-hover:-translate-y-1 text-[14px] font-normal leading-[22px] text-[#7F7F7F] group-hover:text-black transition-all duration-600">
        ...
        <div className="group px-8 pt-8 pb-4 border-t-2 border-[#E0E0E0] hover:border-black transition-all duration-600 bg-[linear-gradient(127deg,transparent_0%,transparent_100%)] hover:bg-[linear-gradient(127deg,#E7ECF2_3.71%,rgba(231,236,242,0)_40.97%)]">
          ...
          <p className="font-[Neue_Montreal] text-[14px] font-normal leading-[22px] text-[#7F7F7F] group-hover:text-black transition-all duration-600 group-hover:-translate-y-1">
      ...
      <div className="grid grid-cols-2">
        <div className="group relative min-h-85 border border-[#ececec] bg-white px-6 py-8 transition-all duration-600 hover:bg-gradient-to-b hover:from-white hover:to-[#ebebeb] sm:px-8 sm:py-10">
